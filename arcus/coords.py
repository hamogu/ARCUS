...
# for on-axis sources
dir0 = np.array([1, 0, 0])
posonaxis = rowland.solve_quartic(y=0, z=z0, interval=[5e4, 12e4])
pos = center * photons['det_x'] * e_x + photons['det_y'] * e_y
# project onto one plane
pos[:, 1] = 0
dir = h2e(pos) - he2(posonaxis)
theta = np.dot()
