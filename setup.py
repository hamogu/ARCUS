...
PACKAGENAME = metadata.get('package_name', 'arcus')
DESCRIPTION = metadata.get('description', 'Ray-tracing ARCUS with the MARXS package')
AUTHOR = metadata.get('author', 'MIT/Hans Moritz Guenther')
